<!DOCTYPE html><html lang="en"><head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="../images/favicon_127.png">
    <link rel="apple-touch-icon" href="../images/apple-touch-icon-57x57_127.png">
    <link rel="apple-touch-icon" sizes="72x72" href="../images/apple-touch-icon-72x72_127.png">
    <link rel="apple-touch-icon" sizes="114x114" href="../images/apple-touch-icon-114x114_127.png">

    <!-- plugins -->
    <link rel="stylesheet" href="../css/plugins_127.css">

    <!-- search css -->
    <link rel="stylesheet" href="../css/search_127.css">

    <!-- quform css -->
    <link rel="stylesheet" href="../css/base_127.css">

    <!-- theme core css -->
    <link href="../css/styles_127.css" rel="stylesheet">
                    ...
                    <div class="menu_area alt-font">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            <div class="navbar-header navbar-header-custom">
                                <!-- start logo -->
                                <a href="./" class="navbar-brand"><img id="logo" src="../images/logo-inner_127.png" alt="logo"></a>
                                <!-- end logo -->
                            </div>
                    ...
                    <div class="col-lg-6 bg-img cover-background overflow-visible rounded" data-wow-delay="100ms" data-overlay-dark="0" data-background="img/bg/bg-07.jpg">
                        <div class="d-flex about-contact">
                            ...
                            <div class="contact-text">
                                ...
                                <span class="text-white fw-bold"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ef9c9a9f9f809d9baf838a8e998a8c8081818a8c9bc18c8082">[email&nbsp;protected]</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container-fluid px-0">
                <div class="owl-theme owl-carousel portfolio-carousel-02">
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-01_127.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-02_127.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-03_127.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-04_127.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-05_127.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-06_127.jpg" class="rounded" alt="...">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="pe-lg-1-9">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="../images/sign_127.png" class="w-60px rounded-circle" alt="...">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="../images/testimonial-01_127.jpg" class="rounded" alt="...">
                            </div>
                            <div class="col-sm-6 d-none d-sm-block">
                                <img src="../images/testimonial-02_127.jpg" class="mb-3 rounded" alt="...">
                                <div class="bg-primary p-1-6 border-bottom border-width-3 rounded border-secondary-color">
                                    <img src="../images/icon-14_127.png" class="mb-3" alt="...">
...
<noscript> Powered by <a href=“https://www.smartsupp.com” target=“_blank”>Smartsupp</a></noscript>
    ...
    <!-- jQuery -->
    <script src="jquery.min_127.js"></script>

    <!-- popper js -->
    <script src="popper.min_127.js"></script>

    <!-- bootstrap -->
    <script src="bootstrap.min_127.js"></script>

    <!-- jquery -->
    <script src="core.min_127.js"></script>

    <!-- Search -->
    <script src="search_127.js"></script>

    <!-- custom scripts -->
    <script src="main_127.js"></script>

    <!-- form plugins js -->
    <script src="plugins_127.js"></script>

    <!-- form scripts js -->
    <script src="scripts_127.js"></script>
