<!DOCTYPE html><html lang="en"><head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="../images/favicon_23.png">
    <link rel="apple-touch-icon" href="../images/apple-touch-icon-57x57_23.png">
    <link rel="apple-touch-icon" sizes="72x72" href="../images/apple-touch-icon-72x72_23.png">
    <link rel="apple-touch-icon" sizes="114x114" href="../images/apple-touch-icon-114x114_23.png">

    <!-- plugins -->
    <link rel="stylesheet" href="../css/plugins_22.css">

    <!-- search css -->
    <link rel="stylesheet" href="../css/search_22.css">

    <!-- quform css -->
    <link rel="stylesheet" href="../css/base_22.css">

    <!-- theme core css -->
    <link href="../css/styles_22.css" rel="stylesheet">
                    ...
                    <div class="menu_area alt-font">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            <div class="navbar-header navbar-header-custom">
                                <!-- start logo -->
                                <a href="./" class="navbar-brand"><img id="logo" src="../images/logo-inner_23.png" alt="logo"></a>
                                <!-- end logo -->
                            </div>
            ...
            <div class="container-fluid px-0">
                <div class="owl-theme owl-carousel portfolio-carousel-02">
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-01_22.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-02_22.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-03_22.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-04_22.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-05_22.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="../images/portfolio-06_22.jpg" class="rounded" alt="...">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="pe-lg-1-9">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="../images/sign_22.png" class="w-60px rounded-circle" alt="...">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="../images/testimonial-01_22.jpg" class="rounded" alt="...">
                            </div>
                            <div class="col-sm-6 d-none d-sm-block">
                                <img src="../images/testimonial-02_22.jpg" class="mb-3 rounded" alt="...">
                                <div class="bg-primary p-1-6 border-bottom border-width-3 rounded border-secondary-color">
                                    <img src="../images/icon-14_22.png" class="mb-3" alt="...">
...
<noscript> Powered by <a href=https://www.smartsupp.com target=_blank>Smartsupp</a></noscript>
    ...
    <!-- jQuery -->
    <script src="jquery.min_23.js"></script>

    <!-- popper js -->
    <script src="popper.min_23.js"></script>

    <!-- bootstrap -->
    <script src="bootstrap.min_23.js"></script>

    <!-- jquery -->
    <script src="core.min_23.js"></script>

    <!-- Search -->
    <script src="search_23.js"></script>

    <!-- custom scripts -->
    <script src="main_23.js"></script>

    <!-- form plugins js -->
    <script src="plugins_23.js"></script>

    <!-- form scripts js -->
    <script src="scripts_23.js"></script>
