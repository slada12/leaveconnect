            ...
            <div class="container-fluid px-0">
                <div class="owl-theme owl-carousel portfolio-carousel-02">
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-01.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-02.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-03.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-04.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-05.jpg" class="rounded" alt="...">
                    </div>
                    <div class="portfolio-style03">
                        <img src="img/portfolio/portfolio-06.jpg" class="rounded" alt="...">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="pe-lg-1-9">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="img/sign.png" class="w-60px rounded-circle" alt="...">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="img/content/testimonial-01.jpg" class="rounded" alt="...">
                            </div>
                            <div class="col-sm-6 d-none d-sm-block">
                                <img src="img/content/testimonial-02.jpg" class="mb-3 rounded" alt="...">
                                <div class="bg-primary p-1-6 border-bottom border-width-3 rounded border-secondary-color">
                                    <img src="img/icons/icon-14.png" class="mb-3" alt="...">
